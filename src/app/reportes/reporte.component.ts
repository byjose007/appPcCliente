...
export class ReporteComponent implements OnInit {
  ...
  aderirImagen(i, src) {
    ...
    img.onload = (c) => {
      ...
      this.doc.text(120, ((i+3) * 20)+5, this.valores[i].fecha);
      this.doc.addImage(img, 'png', 170, (i+3) * 20,15,15);
      this.aderirImagen(i + 1,this.valores[i + 1] != undefined ? this.valores[i + 1].imagenFace:"");
    };
    img.setAttribute('crossOrigin', 'anonymous');
    img.src = src;
    //img.src = "http://localhost:8000/media/registro/Steffany_1103427504_13_Ka0eDzT.png";   
  }
  public downloadRegistros() {
    ...
    img.onload = (c) => {
        ...
        this.aderirImagen(0, this.valores[0].imagenFace);
        //doc.save('test.pdf');
    };
    img.crossOrigin = 'anonymous';
    img.setAttribute('crossOrigin', 'anonymous');
    img.src = './assets/media/logo-municipio.png';
    //img.src = 'http://localhost:8000/media/registro/julio_plaza.png';            
    //img.src = "http://localhost:8000/media/registro/Julio_Ivan_Plaza_Jadan_1103819338_6_face_50YURJe.png";
  ...
  public getData() {
    ...
    this.AppGeneric.getDataIdFechas("registrosFecha",this.empleado.id,this.fechaDesde,this.fechaHasta).subscribe(data => {
      let items: any = data;
      this.allItems = items;
