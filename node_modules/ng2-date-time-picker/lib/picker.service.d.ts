...
export declare class PickerService {
    ...
    constructor();
    setPickerOptions(dtLocale: string, dtViewFormat: string, dtReturnObject: string, dtPositionOffset: string, dtMode: 'popup' | 'dropdown' | 'inline', dtHourTime: '12' | '24', dtTheme: string, dtPickerType: 'both' | 'date' | 'time'): void;
